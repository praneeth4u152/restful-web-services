 ...
 * 
 * @Component public class JwtTokenAuthorizationOncePerRequestFilter extends
 ...
 * 
 * String username = null; String jwtToken = null; if (requestTokenHeader !=
 ...
 * 
 * logger.debug("JWT_TOKEN_USERNAME_VALUE '{}'", username); if (username != null
